...
public class RecyclerItemViewAssertion<A> implements ViewAssertion {
    ...
    private A item;
    private MainRecyclerViewInteraction.ItemViewAssertion<A> itemViewAssertion;

    public RecyclerItemViewAssertion(int position, A item, MainRecyclerViewInteraction.ItemViewAssertion<A> itemViewAssertion) {
